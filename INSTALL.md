# Universal Hotkey Manager for Skyrim SE-AE 1.0.4 - Installation
...
1. Install `Universal Hotkey Manager for Skyrim SE-AE 1.0.4 - Release.zip` as a normal mod.
...
Replace the previous UHM files with the files from the new release. Version 1.0.4 contains only the SKSE plugin and documentation; it does not create an ESP or load-order entry.
